...
export function addAcc(institutionName: string, accountName: string, industry: Industry) {
    return invoke()<number>("add_acc", { institutionName,accountName,industry })
}
...
export function addSuperAcc() {
    return invoke()<null>("add_super_acc")
}
